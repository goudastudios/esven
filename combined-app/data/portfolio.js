module.exports = [
  {
    ...
    name: "Aether",
    description:
      "AI-powered financial modeling platform for investment firms and corporations.",
    ...
    tags: ["AI", "FinTech", "Analytics", "Exit"],
    links: [
      { text: "Case Study", url: "#" },
      { text: "Press Release", url: "#" },
    ],
    categories: ["fintech", "exits", "unicorns"],
  },
  {
    id: "almanac",
    name: "Almanac",
    description:
      "Document collaboration platform for modern teams with built-in version control.",
    logo: "/assets/images/portfolio/almanac.jpg",
    status: "exit",
    metrics: [
      { value: "$1.8B", label: "Exit Value" },
      { value: "8.2x", label: "Multiple" },
      { value: "2021", label: "Exit Year" },
    ],
    tags: ["SaaS", "Productivity", "Exit"],
    links: [
      { text: "Case Study", url: "#" },
      { text: "Press Release", url: "#" },
    ],
    categories: ["enterprise", "exits", "unicorns"],
  },
  {
    id: "better",
    name: "Better",
    description:
      "Digital mortgage lender making homeownership more accessible and affordable.",
    logo: "/assets/images/portfolio/better.jpg",
    status: "exit",
    metrics: [
      { value: "$7.7B", label: "Exit Value" },
      { value: "15.3x", label: "Multiple" },
      { value: "2020", label: "Exit Year" },
    ],
    tags: ["FinTech", "Real Estate", "Lending", "Exit"],
    links: [
      { text: "Case Study", url: "#" },
      { text: "Press Release", url: "#" },
    ],
  ...
  },
  {
    ...
    name: "Blockstream",
    description:
      "Blockchain technology company focused on Bitcoin and sidechain development.",
    logo: "/assets/images/portfolio/blockstream.jpg",
    status: "exit",
    metrics: [
      { value: "$5.4B", label: "Exit Value" },
      { value: "22.1x", label: "Multiple" },
      { value: "2022", label: "Exit Year" },
    ],
    tags: ["Blockchain", "Crypto", "Bitcoin", "Exit"],
    links: [
      { text: "Case Study", url: "#" },
      { text: "Press Release", url: "#" },
    ],
  ...
  },
  {
    ...
    name: "8Bit Capital",
    description:
      "Venture capital firm investing in early-stage blockchain and cryptocurrency startups.",
    logo: "/assets/images/portfolio/8bitcapital.jpg",
    status: "active",
    metrics: [
      { value: "$2.1B", label: "Valuation" },
      { value: "3.5x", label: "TVPI" },
      { value: "2020", label: "Vintage" },
    ],
    tags: ["Crypto", "Blockchain", "Venture"],
    links: [
      { text: "Portfolio", url: "#" },
      { text: "Website", url: "https://8bitcapital.com" },
    ],
    categories: ["fintech", "active", "unicorns"],
  },
  {
    id: "blitzscalingventures",
    name: "Blitzscaling Ventures",
    description:
      "Early-stage venture firm backing mission-driven founders building the future of work.",
    logo: "/assets/images/portfolio/blitzscalingventures.jpg",
    status: "active",
    metrics: [
      { value: "$1.5B", label: "Valuation" },
      { value: "2.8x", label: "TVPI" },
      { value: "2019", label: "Vintage" },
    ],
    tags: ["Venture", "Investing", "Early Stage"],
    links: [
      { text: "Portfolio", url: "#" },
      { text: "Website", url: "https://blitzscaling.vc" },
    ],
    categories: ["enterprise", "active", "unicorns"],
  },
  {
    id: "wyre",
    name: "Wyre",
    description: "Commission-free investing platform democratizing finance.",
    logo: "/images/portfolio/wyre-logo.png",
    status: "active",
    metrics: [
      { value: "$8.2B", label: "Valuation" },
      { value: "12x", label: "Multiple" },
    ],
    tags: ["FinTech", "Consumer", "Trading"],
    links: [
      { text: "Details", url: "#" },
      { text: "Visit", url: "https://www.sendwyre.com/" },
    ],
    categories: ["fintech", "consumer", "unicorns"],
  },
  {
    id: "aether",
    name: "Aether",
